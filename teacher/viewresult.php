	...
	<div class="col-md-9">
		...
		<div class="card mt-3" id="generateResult">
			<div class="card-header">
				<h4 class="float-left">View Result</h4>
				<div class="float-right"><a class="btn btn-success text-white" href="result.php">Add Result</a></div>
			</div>
			<div class="card-body">
				<form method = "post" id="saveForm" action ="../php_actions/teacher/viewresult.php">
					...
					<div class="form-group row mb-3">
						...
						<div class="col-md-4">
							<input type="text" readonly = "readonly" name="date" id="date" placeholder="Choose Year" class="form-control">
						</div>
					</div>	
...
<div class="scripts">
    <script src="../custom/js/viewresult.js"></script>
</div>
